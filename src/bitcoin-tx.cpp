...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s qcity-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  qcity-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qcity transaction") + "\n" +
              "  qcity-tx [options] -create [commands]   " + _("Create hex-encoded qcity transaction") + "\n" +
              "\n";
