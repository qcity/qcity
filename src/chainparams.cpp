...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed4", "qct005.bitchk.com",true));
        vSeeds.push_back(CDNSSeedData("seed4", "qct006.bitchk.com",true));
        vSeeds.push_back(CDNSSeedData("seed4", "qct007.bitchk.com",true));
        vSeeds.push_back(CDNSSeedData("seed4", "qct008.bitchk.com",true));
