...
const char * const BITCOIN_CONF_FILENAME = "qcity.conf";
const char * const BITCOIN_PID_FILENAME = "qcity.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Qcity";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Qcity";
#else
    // Unix
    return pathRet / ".qcity";
#endif
#endif
}
